    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('') ?>">
                ...
                <div class="sidebar-brand-text mx-3">GDS Network <sup><?= date('y') ?></sup></div>
            </a>
            ...
            <li class="nav-item <?= ($judul=="Admin" || $judul == "Level Admin") ? "active" : ""?>">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?= ($judul=="Admin") ? "active" : ""?>" href="<?= base_url('index.php/admin')?>">Admin</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Fatur Rizqy Alfarisz</span>
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; GDS Network x Fatur <?= date('Y') ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
